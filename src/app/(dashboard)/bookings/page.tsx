...
import { bookingsData, captainsData, servicesList, statusOptions } from "@/data/mock";
    ...
    <>
      ...
      <Tabs defaultValue="all" className="w-full">
        ...
        <TabsContent value="scheduled" className="mt-6">
          <DataTable
            columns={columns}
            data={bookingsData.filter((booking) => booking.status === "scheduled")}
            onRowClick={handleViewBooking}
            onView={handleViewBooking}
            onEdit={handleEditBooking}
            onDelete={handleDeleteBooking}
        ...
        <TabsContent value="ongoing" className="mt-6">
          <DataTable
            columns={columns}
            data={bookingsData.filter((booking) => booking.status === "ongoing")}
            onRowClick={handleViewBooking}
            onView={handleViewBooking}
            onEdit={handleEditBooking}
            onDelete={handleDeleteBooking}
        ...
        <TabsContent value="completed" className="mt-6">
          <DataTable
            columns={columns}
            data={bookingsData.filter((booking) => booking.status === "completed")}
            onRowClick={handleViewBooking}
            onView={handleViewBooking}
            onEdit={handleEditBooking}
            onDelete={handleDeleteBooking}
