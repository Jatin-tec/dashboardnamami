...
const ServiceDetail = ({ service }: { service: Service | null }) => {
  ...
  if (!service) return (
    <div className="flex items-center justify-center h-full">
      <p className="text-lg text-muted-foreground">
        Service not found. Please check the service code or try again later.
      </p>
    </div>
  );
  ...
  return (
    <>
      <PageHeader
        title={service.name}
        description={`Details for ${service.name} service`}
          ...
          <Card className="overflow-hidden border-none shadow-md">
            <div className="relative aspect-[16/9] bg-muted">
              ...
              <div className="absolute bottom-4 right-4 z-20 flex items-center gap-2">
                ...
                >
                  <Clock className="h-3 w-3 mr-1" /> {service.slots * 90} min
                </Badge>
                <Badge
                  variant="outline"
                  className="bg-white/80 text-primary backdrop-blur-sm border-none"
            ...
            <div className="p-4 flex gap-2 overflow-x-auto bg-muted/5">
              {service.gallery.map((image, index) => (
                <div
                  key={index}
                  className={`w-20 h-20 flex-shrink-0 cursor-pointer rounded-md overflow-hidden transition-all ${selectedImage === index
            ...
            <CardHeader>
              <CardTitle className="flex items-center">
                <div className="mr-2 bg-primary/10 p-2 rounded-full">
                  <Image src={service.icon} alt={service.name} width={24} height={24} className="h-5 w-5" />
                </div>
                About This Service
              </CardTitle>
              <CardDescription>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex items-center justify-between border-b pb-2">
                ...
                <div className="flex items-center gap-1">
                  ...
                  <span>{service.slots * 90} minutes</span>
                </div>
              </div>
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {service.available_cities.map((city, key) => (
                    <Badge
                      key={key}
                      variant="outline"
      ...
      <Tabs defaultValue="packages" className="mb-6">
        ...
        <TabsContent value="packages" className="space-y-6">
          ...
          <DataTable
            ...
            data={service.subscription_plans}
